...
export default function SearchBar(props: SearchBarProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 items-center justify-center mb-2 animate-slide-up">
      <div className="relative flex-1 w-full lg:max-w-2xl">
        <div className="w-full bg-slate-900/50 backdrop-blur-sm px-6 py-4 gap-x-4 border border-slate-600/30 rounded-2xl items-center flex">
      ...
      <div className="flex gap-3 shrink-0">
        <Popover
          triggerElement={
            <div className="group relative overflow-hidden cursor-pointer bg-gradient-to-r from-cyan-500 to-cyan-700 hover:from-cyan-500 hover:to-cyan-400 px-6 py-3 rounded-2xl font-semibold text-white transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-primary-500/25">
